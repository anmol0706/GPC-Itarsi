...
const Gallery = () => {
  ...
  const handleDeleteImage = async (imageId) => {
    ...
    try {
      ...
      await axios.delete(`${config.apiUrl}/api/gallery/${imageId}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-primary-800">Gallery Management</h1>
        <button
              ...
              <div key={image._id} className="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div className="px-4 py-4">
                  ...
                  <p className="mt-2 text-xs text-gray-400">
                    ...
                    {image.image && image.image.startsWith('http') && <span className="ml-1">(Cloudinary)</span>}
                  </p>
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                      <h3 className="text-lg leading-6 font-medium text-primary-800">Add New Image</h3>
