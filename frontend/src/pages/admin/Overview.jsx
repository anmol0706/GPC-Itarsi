  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch students
        const studentsRes = await axios.get(`${config.apiUrl}/api/students`);

        // Fetch teachers
        const teachersRes = await axios.get(`${config.apiUrl}/api/teachers`);

        // Fetch notices
        const noticesRes = await axios.get(`${config.apiUrl}/api/notices`);

        // Fetch gallery
        const galleryRes = await axios.get(`${config.apiUrl}/api/gallery`);

        // Fetch courses
        const coursesRes = await axios.get(`${config.apiUrl}/api/courses`);

        // Fetch study materials
        const materialsRes = await axios.get(`${config.apiUrl}/api/study-materials`);

        // Fetch overview data
        const overviewRes = await axios.get(`${config.apiUrl}/api/overview`);
