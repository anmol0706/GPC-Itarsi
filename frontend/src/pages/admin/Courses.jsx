  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-primary-800">Manage Courses</h1>
        <button
          onClick={openAddModal}
          className="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md border border-primary-500/30"
        >
          Add New Course
        </button>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-screen overflow-y-auto">
            ...
            <form onSubmit={handleAddCourse}>
              ...
              <div className="px-6 py-4 border-t bg-gray-50 flex justify-end space-x-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 border border-primary-500/30"
                  disabled={loading}
                >
