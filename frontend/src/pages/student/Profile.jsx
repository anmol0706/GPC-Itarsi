...
const Profile = () => {
  ...
  const fetchStudentProfile = async () => {
    try {
      ...
      const response = await axios.get(`${config.apiUrl}/api/students/profile`, {
        headers: {
  ...
  const handleUpdateProfilePicture = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${config.apiUrl}/api/students/update-profile-picture`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 flex flex-col items-center">
              ...
              <h3 className="mt-4 text-lg leading-6 font-medium text-gray-900">{studentData?.name}</h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">{studentData?.rollNumber}</p>
              ...
              <button
                ...
                className="mt-4 w-full inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Change Password
              </button>
            </div>
            ...
            <div className="border-t border-gray-200">
              <dl>
                ...
                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">Student</dd>
                </div>
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
