...
const StudyMaterials = () => {
    ...
    try {
      ...
      const materialsWithFileStatus = await Promise.all(
        allMaterials.map(async (material) => {
          try {
            if (material.fileUrl) {
              await axios.head(`${axios.defaults.baseURL}/uploads/study-materials/${material.fileUrl}`);
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-primary-800">Study Materials</h1>
                    ...
                    <div className="px-4 py-5 sm:p-6">
                      <div className="flex flex-col h-full">
                        ...
                        <div className="mt-4">
                          {material.fileExists ? (
                            <a
                              href={`${axios.defaults.baseURL}/uploads/study-materials/${material.fileUrl}`}
                              target="_blank"
