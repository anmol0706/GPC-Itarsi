...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Redirect if not student and not in loading state
    if (!loading && !isStudent) {
      navigate('/login');
    }
  }, [isStudent, navigate, loading]);

  // Show loading spinner while authentication is in progress
  if (loading) {
    return <LoadingSpinner message="Loading student dashboard..." fullScreen={true} />;
  }
            ...
            <div className="flex-shrink-0 group block">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm font-medium text-accent-300">Student</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex-shrink-0 w-full group block">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs font-medium text-accent-300">Student</p>
                  </div>
                </div>
              </div>
            </div>
