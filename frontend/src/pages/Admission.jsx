          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
                <span className="block">{admissionDetails.pageTitle}</span>
                <span className="block text-accent-400">{admissionDetails.pageSubtitle}</span>
              </h1>
              <p className="mt-6 max-w-lg mx-auto text-xl text-primary-100 sm:max-w-3xl">
                {admissionDetails.pageDescription}
              </p>
            </div>
          </div>
                ...
                <div className="relative overflow-hidden rounded-xl p-8 shadow-lg">
                  ...
                  <div className="relative flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div className="max-w-xl">
                      <h2 className="text-2xl font-bold text-primary-800">Diploma Admissions {admissionDetails.academicYear}</h2>
                      <p className="mt-2 text-base text-gray-600">Last date to apply: <span className="font-semibold text-primary-700">{formatDate(admissionDetails.applicationPeriod.endDate)}</span></p>
                      <div className="mt-4 flex flex-wrap gap-3">
                        <span className="inline-flex items-center rounded-full bg-green-100 px-3 py-1 text-sm font-medium text-green-800">
                          <svg className="mr-1.5 h-2 w-2 text-green-600" fill="currentColor" viewBox="0 0 8 8">
                            <circle cx="4" cy="4" r="3" />
                          </svg>
                          {admissionDetails.applicationPeriod.status}
                        </span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                      ...
                      >
                        ...
                        {admissionDetails.applyButtonText}
                      </a>
                      <a
                      ...
                      >
                        ...
                        {admissionDetails.learnMoreButtonText}
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 transition-all duration-200 hover:shadow-xl">
                ...
                <div className="p-6">
                  <time dateTime="2024-05-15" className="flex items-center text-sm font-semibold text-primary-600">
                    ...
                    {formatDate(admissionDetails.applicationPeriod.startDate)} - {formatDate(admissionDetails.applicationPeriod.endDate)}
                  </time>
                  <h3 className="mt-4 text-lg font-bold text-gray-900">Application Period</h3>
                  <p className="mt-2 text-base text-gray-600">{admissionDetails.additionalInfo}</p>
                  <div className="mt-4">
                    <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${admissionDetails.applicationPeriod.status === 'Currently Active' ? 'bg-green-100 text-green-800' : admissionDetails.applicationPeriod.status === 'Coming Soon' ? 'bg-gray-100 text-gray-800' : 'bg-yellow-100 text-yellow-800'}`}>
                      {admissionDetails.applicationPeriod.status}
                    </span>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 transition-all duration-200 hover:shadow-xl">
                ...
                <div className="p-6">
                  <time dateTime="2024-06-10" className="flex items-center text-sm font-semibold text-primary-600">
                    ...
                    {formatDate(admissionDetails.entranceExam.startDate)} - {formatDate(admissionDetails.entranceExam.endDate).split(' ').pop()}
                  </time>
                  ...
                  <div className="mt-4">
                    <span className="inline-flex items-center rounded-full bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800">
                      {admissionDetails.entranceExam.status}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 transition-all duration-200 hover:shadow-xl">
                ...
                <div className="p-6">
                  <time dateTime="2024-08-01" className="flex items-center text-sm font-semibold text-primary-600">
                    ...
                    {formatDate(admissionDetails.classesBegin.date)}
                  </time>
                  ...
                  <div className="mt-4">
                    <span className="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">
                      {admissionDetails.classesBegin.status}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-between">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-medium text-gray-900">{formatDate(admissionDetails.applicationPeriod.startDate).split(' ')[0]} {formatDate(admissionDetails.applicationPeriod.startDate).split(' ')[1].replace(',', '')}</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-medium text-gray-900">{formatDate(admissionDetails.entranceExam.startDate).split(' ')[0]} {formatDate(admissionDetails.entranceExam.startDate).split(' ')[1].replace(',', '')}-{formatDate(admissionDetails.entranceExam.endDate).split(' ')[1].replace(',', '')}</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-medium text-gray-900">{formatDate(admissionDetails.results.date).split(' ')[0]} {formatDate(admissionDetails.results.date).split(' ')[1].replace(',', '')}</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-medium text-gray-900">{formatDate(admissionDetails.counseling.startDate).split(' ')[0]} {formatDate(admissionDetails.counseling.startDate).split(' ')[1].replace(',', '')}-{formatDate(admissionDetails.counseling.endDate).split(' ')[1].replace(',', '')}</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-medium text-gray-900">{formatDate(admissionDetails.classesBegin.date).split(' ')[0]} {formatDate(admissionDetails.classesBegin.date).split(' ')[1].replace(',', '')}</span>
          ...
          <div className="lg:col-span-2 bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                {admissionDetails.applicationSteps && admissionDetails.applicationSteps.length > 0 ? (
                  admissionDetails.applicationSteps.map((step, index) => (
                    <div key={index} className="bg-white rounded-lg p-4 border border-gray-200 hover:border-primary-200 hover:shadow-md transition-all duration-200">
                      <div className="flex items-start">
                        <div className="flex-shrink-0">
                          <div className="flex items-center justify-center h-8 w-8 rounded-full bg-primary-100 text-primary-600 font-bold text-lg">{index + 1}</div>
                        </div>
                        <div className="ml-4">
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">
              {admissionDetails.faqSection.title || 'Frequently Asked Questions'}
            </h2>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid gap-6">
              {admissionDetails.faqSection.items && admissionDetails.faqSection.items.length > 0 ? (
                admissionDetails.faqSection.items.map((faq, index) => (
                  <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100">
                    <div className="p-6">
                      <div className="flex items-start">
